...
이용약관
제1조 목적
본 약관은 RECOMEDI(이하 ‘회사’라 함)가 제공하는 서비스의 이용과 관련하여 기본적인 사항을 정함으로써 회사와 이용자의 권리, 의무 및 책임사항, 기타 필요한 사항을 명확하게 규정함을 목적으로 합니다.

제2조 용어의 정의
본 약관에서 사용하는 용어의 정의는 다음과 같습니다.


서비스: 회사가 개발 및 운영하는 소프트웨어인 "내가먹는약 한큐에!"를 이용할 수 있도록 지원하는 서비스(이하 ‘서비스’)를 의미합니다.
...
제3조 약관의 게시와 개정
1. 회사는 본 약관의 내용을 이용자가 쉽게 알 수 있도록 홈페이지 초기화면 (http://biso150.cafe24.com, 이하 ‘홈페이지’)에 게시합니다.
...
제5조 이용계약의 성립(체결)
이용계약은 이용자가 약관의 내용에 대하여 동의를 한 다음 회사가 제시하는 양식과 절차에 따라 이용신청을 하고 회사가 이러한 신청에 대하여 승낙함으로써 체결됩니다.

회사는 이용자의 서비스 이용 신청에 대하여 서비스 이용 승낙을 원칙으로 합니다. 다만, 회사는 다음 각호에 해당하는 신청에 대하여는 승낙을 하지 않거나 사후에 이용계약을 해지할 수 있습니다.
...
3. 이용자가 서비스 이용 도중 서비스를 추가하는 경우에는 추가한 날짜 기준 활성사용자수에 따라 과금됩니다.

4. 서비스 이용요금 과금 시작일은 무료 사용 기간이 지난 무료사용만료일의 익일(이하 '과금일')입니다. 매월 과금일에는 등록해놓은 신용 또는 체크카드로 과금일 시점의 활성 사용자수에 따라 정기 결제됩니다. 관리자가 계정을 개설하고, 구성원을 초대해 ID및 비밀번호로 biso150.cafe24.com 서비스 로그인 화면에 로그인할 수 있게 된 시점(이하가 ‘개설된 시점일’)이라 합니다. 단, 이용계약에서 별도 과금 기준일을 정한 경우 해당 내용이 본 약관에 우선하여 적용됩니다.

5. 서비스 이용 도중 요금과금 기준이 변경되더라도 이미 결제가 완료된 서비스 이용분에 대하여 증감된 서비스 이용요금을 추가로 청구하거나 환불하지 않습니다.
...
- 이용자는 결제수단의 비밀번호, 인증서 등의 유출로 인한 부정사용 또는 위변조 사고가 발생하지 않도록 주의하여야 합니다. 특히 이용자는 신용카드의 미서명, 관리 소홀, 무단 대여나 양도 또는 담보제공으로 인한 부정사용, 불법 현금대출, 위변조 사조 등이 발생하지 않도록 주의하여야 합니다.
5. 회사는 서비스 이용요금 결제가 정상적으로 이루어지지 않은 경우 이용자의 서비스 이용을 제한할 수 있으며, 서비스 이용요금을 미납하는 등 이용자의 귀책 사유로 회사가 서비스 이용을 제한한 경우 이용자에게 발생한 손해에 대해서 회사는 면책됩니다.
...
이용자가 불법으로 서비스 이용요금 등을 면탈할 경우에는 면탈한 금액의 10배에 해당하는 금액을 청구합니다.
...
제 23조 서비스 등의 보호
1. 이용자는 biso150.cafe24.com를 무단 복제하거나 고의 또는 과실로 biso150.cafe24.com 및 서비스에 관한 정보를 외부에 유출할 수 없습니다.

2. 이용자는 이용계약 도중 또는 종료 후 라고 하더라도 biso150.cafe24.com와 유사한 솔루션의 제작/판매행위를 할 수 없으며, 제3자를 통한 우회적 제작/판매행위도 이용자 본인의 행위로 간주합니다.
...
2. 서비스 이용기간 만료, 서비스 이용계약의 해제 또는 해지 등의 사유로 회사가 서비스 제공을 종료한 경우 회사는 구성원의 정보를 비롯한 모든 데이터를 즉시 파기합니다. 단, 다음 정보들은 관련 법령에 따라 개인정보를 일정 기간 동안 보존하며, 해당 개인정보 또는 개인정보 파일을 다른 개인정보와 분리하여서 저장, 관리하고 보존기간 경과 후 파기 합니다.

3. 무료체험 서비스 신청시 수집한 정보주체(최고관리자)의 일부 개인정보
...
제 26조 손해배상의 범위 및 청구
1. 회사의 귀책사유로 이용자가 서비스를 이용하지 못한 경우에는 (이하 ‘장애’라 합니다) 다음 각 호의 기준에 따라 배상합니다. 다만, 이용자가 서비스를 이용하지 못한 때로부터 8시간 이내에 서비스가 정상화 된 경우는 제외합니다.

- 회사는 회사의 귀책사유로 사전 고지 없이 발생한 장애 시간이 연속하여 8시간 이상인 경우 또는 이용자가 장애 발생 사실을 회사에 통보하거나 회사가 알게 된 때로부터 연속하여 8시간 이상인 경우 이용자가 입은 손해를 배상 합니다
- 서비스가 정상화 된 이후 4시간 이내에 동일한 장애가 발생한 경우 이는 연속된 장애로 간주합니다
- 회사는 이용자가 서비스를 이용하지 못한 일수의 2배의 이용 기간을 무료로 연장하여 제공합니다. 단, 연속하여 8시간 이상 서비스를 이용하지 못한 날을 1일로 계산합니다.
본 조에서 장애라 함은 다음 각 호에 해당하는 경우 장애라고 판단합니다.


1. 회사의 귀책 사유로 biso150.cafe24.com 서비스에 로그인하지 못한 경우

2. 서비스에 데이터를 게시 또는 업로드 하지 못하거나 서비스 내 저장된 데이터를 열람하지 못한 경우

3. 단, 회사가 사전에 고지한 경우는 제외합니다.

4. 회사가 고의 또는 과실로 이용자에게 손해를 끼친 경우, 손해에 대하여 배상할 책임이 있습니다.

5. 이용자가 고의 또는 과실로 회사에 손해를 끼친 경우, 이용자는 회사에 대하여 그 손해에 대하여 배상할 책임이 있습니다.

6. 회사는 그 손해가 천재지변 등 불가항력이거나 이용자의 고의 또는 과실로 인하여 발생된 때에는 손해배상을 하지 않습니다.

7. 손해 배상의 청구는 회사에 청구사유, 청구금액 및 산출근거를 기재하여 이메일, 전화 등으로 신청하여야 합니다.

8. 회사 및 타인에게 피해를 주어 피해자의 고발 또는 소송 제기로 인하여 손해배상이 청구된 이용자는 회사 및 수사기관의 요청에 적극 협조하여야 합니다.
...
6. 회사는 이용자가 서비스 이용 종료 후 제 24조에 따라 파기된 데이터와 이용자가 직접 삭제를 요청한 데이터 기타 서비스 이용 중인지 여부를 불문하고 백업의무를 소홀히 하여 발생한 데이터의 손실에 대해서는 책임을 지지 않습니다.
